/* Майстер-Трекер — photo data transport fix v65.0-security.14
   ...
   Наслідок: фото видно в заявці, але вони не доходять ні в системний Share,
   ні в Telegram; Telegram backup обривається до ticket-*.json.
...
const PHOTO_DATA_FETCH_RELEASE_LABEL = 'v65.0-security.14 · 2026-08-18';
