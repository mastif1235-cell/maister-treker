...
function securityRuntimeSanitizeTicket(ticket,index=0){
  ...
  const short=['date','time','type','city','street','house','apartment','clientName','phone','payment','contractNumber','contractNumberDate','contractNumberMastersKey','login','macAddress','signal','cityId','streetId'];
