...
«Спільний backend» — наш Worker: адреса підставляється автоматично (prod Worker для продакшен-PWA, dev Worker у локальному preview). Потрібен персональний токен — без нього ліміти власника не витрачаються і доступу до даних немає.
