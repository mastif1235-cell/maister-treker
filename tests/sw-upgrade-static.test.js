...
assert.match(source,/CACHE_NAME\s*=\s*'maister-treker-v67-runtime-91'/,'installed-PWA cache revision is unique for the v91.46 production release');
assert.match(appSource,/APP_VERSION\s*=\s*'v91\.46 · 2026-09-19'/,'canonical release identity is v91.46');
