...
assert.match(source,/CACHE_NAME\s*=\s*'maister-treker-v67-runtime-104'/,'installed-PWA cache revision is unique for the v91.60 production release');
assert.match(appSource,/APP_VERSION\s*=\s*'v91\.60 · 2026-09-20'/,'canonical release identity is v91.60');
