...
assert.match(source,/CACHE_NAME\s*=\s*'maister-treker-v67-runtime-113'/,'installed-PWA cache revision is unique for the v91.69 production release');
assert.match(appSource,/APP_VERSION\s*=\s*'v91\.69 · 2026-09-23'/,'canonical release identity is v91.69');
