...
assert.match(source,/CACHE_NAME\s*=\s*'maister-treker-v67-runtime-109'/,'installed-PWA cache revision is unique for the v91.65 production release');
assert.match(appSource,/APP_VERSION\s*=\s*'v91\.65 · 2026-09-22'/,'canonical release identity is v91.65');
