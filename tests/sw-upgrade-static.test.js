...
assert.match(source,/CACHE_NAME\s*=\s*'maister-treker-v67-runtime-66'/,'installed-PWA cache revision is unique for the v91.27 post-audit fixes release');
assert.match(appSource,/APP_VERSION\s*=\s*'v91\.27 · 2026-09-14'/,'canonical release identity is v91.27');
