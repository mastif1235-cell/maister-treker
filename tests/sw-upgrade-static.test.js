...
assert.match(source,/CACHE_NAME\s*=\s*'maister-treker-v67-runtime-70'/,'installed-PWA cache revision is unique for the v91.31 telegram photo dedup release');
assert.match(appSource,/APP_VERSION\s*=\s*'v91\.31 · 2026-09-15'/,'canonical release identity is v91.31');
