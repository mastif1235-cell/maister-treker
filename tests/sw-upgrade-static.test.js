...
assert.match(source,/CACHE_NAME\s*=\s*'maister-treker-v67-runtime-96'/,'installed-PWA cache revision is unique for the v91.52 production release');
assert.match(appSource,/APP_VERSION\s*=\s*'v91\.52 · 2026-09-20'/,'canonical release identity is v91.52');
