...
assert.match(source,/CACHE_NAME\s*=\s*'maister-treker-v67-runtime-106'/,'installed-PWA cache revision is unique for the v91.62 production release');
assert.match(appSource,/APP_VERSION\s*=\s*'v91\.62 · 2026-09-22'/,'canonical release identity is v91.62');
