...
assert.match(source,/CACHE_NAME\s*=\s*'maister-treker-v67-runtime-98'/,'installed-PWA cache revision is unique for the v91.54 production release');
assert.match(appSource,/APP_VERSION\s*=\s*'v91\.54 · 2026-09-20'/,'canonical release identity is v91.54');
