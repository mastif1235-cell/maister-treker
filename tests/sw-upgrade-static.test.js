...
assert.match(source,/CACHE_NAME\s*=\s*'maister-treker-v67-runtime-88'/,'installed-PWA cache revision is unique for the v91.43 production release');
assert.match(appSource,/APP_VERSION\s*=\s*'v91\.43 · 2026-09-19'/,'canonical release identity is v91.43');
