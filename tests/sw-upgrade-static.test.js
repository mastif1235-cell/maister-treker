...
assert.match(source,/CACHE_NAME\s*=\s*'maister-treker-v67-runtime-80'/,'installed-PWA cache revision is unique for the v91.35 production release');
assert.match(appSource,/APP_VERSION\s*=\s*'v91\.35 · 2026-09-17'/,'canonical release identity is v91.35');
