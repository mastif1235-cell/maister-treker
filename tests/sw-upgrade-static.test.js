...
assert.match(source,/CACHE_NAME\s*=\s*'maister-treker-v67-runtime-84'/,'installed-PWA cache revision is unique for the v91.39 production release');
assert.match(appSource,/APP_VERSION\s*=\s*'v91\.39 · 2026-09-18'/,'canonical release identity is v91.39');
