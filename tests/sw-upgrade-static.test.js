...
assert.match(source,/CACHE_NAME\s*=\s*'maister-treker-v67-runtime-112'/,'installed-PWA cache revision is unique for the v91.68 production release');
assert.match(appSource,/APP_VERSION\s*=\s*'v91\.68 · 2026-09-23'/,'canonical release identity is v91.68');
