...
assert.match(source,/CACHE_NAME\s*=\s*'maister-treker-v67-runtime-90'/,'installed-PWA cache revision is unique for the v91.45 production release');
assert.match(appSource,/APP_VERSION\s*=\s*'v91\.45 · 2026-09-19'/,'canonical release identity is v91.45');
