...
assert.match(source,/CACHE_NAME\s*=\s*'maister-treker-v67-runtime-81'/,'installed-PWA cache revision is unique for the v91.36 production release');
assert.match(appSource,/APP_VERSION\s*=\s*'v91\.36 · 2026-09-18'/,'canonical release identity is v91.36');
