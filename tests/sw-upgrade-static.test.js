...
assert.match(source,/CACHE_NAME\s*=\s*'maister-treker-v67-runtime-105'/,'installed-PWA cache revision is unique for the v91.61 production release');
assert.match(appSource,/APP_VERSION\s*=\s*'v91\.61 · 2026-09-21'/,'canonical release identity is v91.61');
