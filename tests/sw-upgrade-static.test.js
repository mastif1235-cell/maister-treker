...
assert.match(source,/CACHE_NAME\s*=\s*'maister-treker-v67-runtime-107'/,'installed-PWA cache revision is unique for the v91.63 production release');
assert.match(appSource,/APP_VERSION\s*=\s*'v91\.63 · 2026-09-22'/,'canonical release identity is v91.63');
