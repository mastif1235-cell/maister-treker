...
assert.match(source,/CACHE_NAME\s*=\s*'maister-treker-v67-runtime-101'/,'installed-PWA cache revision is unique for the v91.57 production release');
assert.match(appSource,/APP_VERSION\s*=\s*'v91\.57 · 2026-09-20'/,'canonical release identity is v91.57');
