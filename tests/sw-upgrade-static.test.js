...
assert.match(source,/CACHE_NAME\s*=\s*'maister-treker-v67-runtime-95'/,'installed-PWA cache revision is unique for the v91.51 production release');
assert.match(appSource,/APP_VERSION\s*=\s*'v91\.51 · 2026-09-20'/,'canonical release identity is v91.51');
