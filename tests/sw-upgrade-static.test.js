...
assert.match(source,/CACHE_NAME\s*=\s*'maister-treker-v67-runtime-103'/,'installed-PWA cache revision is unique for the v91.59 production release');
assert.match(appSource,/APP_VERSION\s*=\s*'v91\.59 · 2026-09-20'/,'canonical release identity is v91.59');
