...
assert.match(source,/CACHE_NAME\s*=\s*'maister-treker-v67-runtime-72'/,'installed-PWA cache revision is unique for the v91.33 move-block release');
assert.match(appSource,/APP_VERSION\s*=\s*'v91\.33 · 2026-09-16'/,'canonical release identity is v91.33');
