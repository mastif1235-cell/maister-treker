...
assert.match(source,/CACHE_NAME\s*=\s*'maister-treker-v67-runtime-67'/,'installed-PWA cache revision is unique for the v91.28 audit items 11-20 release');
assert.match(appSource,/APP_VERSION\s*=\s*'v91\.28 · 2026-09-14'/,'canonical release identity is v91.28');
