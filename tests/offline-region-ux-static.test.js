...
assert.match(adapter,/OBJECT_ICON_SCALE=\{min:\.59,max:\.98\}/,'object markers grow about 30 percent');
assert.match(adapter,/markerElement\('Моє місце'\)/,'GPS remains a separate larger DOM marker');
assert.ok(48/2*.98<36,'largest rendered object pin stays smaller than the 36px GPS pin');
