...
assert.match(domain,/Технічна інформація/);assert.match(domain,/Вибрати файл \.pmtiles і встановити/);assert.match(offline,/navigator&&root\.navigator\.storage/);assert.match(domain,/MTOfflineMap\.install/);
