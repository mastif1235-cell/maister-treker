...
const app=fs.readFileSync('app.js','utf8');const index=fs.readFileSync('index.html','utf8');const sw=fs.readFileSync('sw.js','utf8');
...
assert.match(ticketStorage,/syncEngine\.recordDiff\('ticket'/);assert.match(app,/syncEngine\.recordDiff\('shift'/);
const saveTicketsSource=ticketStorage.slice(ticketStorage.indexOf('function saveTickets()'));
const saveShiftsSource=app.slice(app.indexOf('function saveShifts()'));
