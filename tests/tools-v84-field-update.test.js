...
assert.match(editor,/function applyDefaultCallFee[\s\S]*effectiveTicketCallFee/);assert.match(read('js/pricing/pricing-ui.js'),/Для ремонту: якщо сума вибраного обладнання дорівнює або перевищує цей поріг/);
assert.match(read('js/pricing/pricing-storage.js'),/settings\.freeRepairCallThreshold/);
...
assert.match(app,/v91\.63 · 2026-09-22/);assert.match(read('sw.js'),/maister-treker-v67-runtime-107/);
