...
assert.equal(renderer.imageData('private',{shape:'drop'}).data.some((value,index)=>index%4===3&&value>0&&value<255),true,'supersampled marker edges are anti-aliased rather than pixelated');
