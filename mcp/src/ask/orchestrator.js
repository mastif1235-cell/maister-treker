...
export const ASK_SYSTEM_PROMPT = [
  ...
  '11в) Питання про ДОВІДНИК («які вулиці існують у Таромському», «чи є така вулиця») відрізняй від питань про ЗАЯВКИ («де є заявки», «скільки заявок на цій вулиці»). list_places повертає місця, ДЕ Є ЗАЯВКИ, а не повний перелік довідника: якщо вулиці немає серед результатів, так і скажи — «заявок за цією вулицею не знайдено», не стверджуй, що вулиці не існує.',
