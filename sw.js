const CACHE_NAME = 'maister-treker-v59'; // NEW: захист від падіння всього застосунку (порожній список заявок, версія не завантажується), якщо index.html і app.js на сайті випадково розсинхронізуються — прив'язка кнопок розбивки суми "Змішана оплата" тепер не кидає помилку, якщо відповідних елементів немає в HTML.
const CORE_ASSETS = [
  './',
  './index.html',
  './styles.css',
