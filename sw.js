const CACHE_NAME = 'maister-treker-v44'; // NEW: при оплаті "Безкоштовно" кожна позиція в тексті заявки (виклик/тариф/обладнання/кабелі/роботи) тепер явно показує "0 грн" замість того, щоб просто прибирати ціну — так одразу видно, що саме зроблено безкоштовно.
const CORE_ASSETS = [
  './',
  './index.html',
  './styles.css',
