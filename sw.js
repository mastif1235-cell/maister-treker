const CACHE_NAME = 'maister-treker-v52'; // NEW: кнопка "📜 Договір" у профілі абонента тепер доступна й без номера договору (лише з логіном/паролем) — QR-код і картка для абонента формуються без рядка "№ ...", раніше кнопка ховалась, якщо номера договору немає.
const CORE_ASSETS = [
  './',
  './index.html',
  './styles.css',
