const CACHE_NAME = 'maister-treker-v47'; // NEW: довідкова копія коду Apps Script у Налаштуваннях (кнопка "Копіювати код") оновлена, щоб відповідати реально розгорнутому скрипту користувача (8-й стовпець повніДаніJSON, атомарна заміна листа через тимчасовий лист, розумна вставка нової заявки за позицією, checkTicketExists) — раніше довідкова копія в app.js була застарілою на кілька ітерацій і показувала б старішу, гіршу версію при спробі скопіювати код для нової таблиці.
const CORE_ASSETS = [
  './',
  './index.html',
  './styles.css',
