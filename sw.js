const CACHE_NAME = 'maister-treker-v58'; // NEW: "Змішана оплата" тепер не вимагає рахувати суми вручну — замість двох порожніх полів показується перелік уже вибраних позицій (виклик/обладнання/кабелі/роботи) з перемикачем 💵/💳 на кожну, розбивка готівка/безготівка рахується сама й завжди точно збігається із загальною сумою.
const CORE_ASSETS = [
  './',
  './index.html',
  './styles.css',
