const CACHE_NAME = 'maister-treker-v57'; // NEW: додано новий спосіб оплати "Змішана" — коли частину суми абонент дав готівкою, а частину безготівкою (наприклад, абонплата на карту, а роутер готівкою). З'явились два поля розбивки суми з підказкою, чи зійшлось із загальною сумою; сума враховується в обох підсумках (готівка/безготівка) у "Звіти" пропорційно введеній розбивці.
const CORE_ASSETS = [
  './',
  './index.html',
  './styles.css',
