...
const CORE_ASSETS = [
  ...
  './js/qr-share-domain.js','./js/share-domain.js','./js/reports-domain.js','./js/security-hardening.js','./js/security-lock.js','./js/security-qr.js','./js/security-telegram.js','./js/security-runtime-v65-9.js',
