const CACHE_NAME = 'maister-treker-v36'; // NEW: виправлено вигляд екрана блокування — тема (data-theme) визначає всі кольорові CSS-змінні (--bg/--text/--accent тощо), а перевірка пароля відбувалась ДО застосування теми, тож екран блокування лишався без кольорів (прозорий фон, наче зливався зі статичною розміткою під ним). Тепер тема застосовується першою (це суто косметика, жодних чутливих даних не показує) — екран блокування виглядає як належить.
const CORE_ASSETS = [
  './',
  './index.html',
  './styles.css',
