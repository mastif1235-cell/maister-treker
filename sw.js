const CACHE_NAME = 'maister-treker-v65-security-18-8'; // HMAC transport + ordered sync + true read-only verify.
const CORE_ASSETS = [
...
async function injectSecurityLayer(response){
  ...
  try{
    ...
    add('js/security-sync-locksplit-v65-18-7.js');
    add('js/security-sync-fastverify-v65-18-8.js');
