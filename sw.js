const CACHE_NAME = 'maister-treker-v67-runtime-71';
const CORE_ASSETS = [
  ...
  './js/telegram-backup-reliability-v65-13.js','./js/security-dom-final-v65-18.js','./js/backup-system.js','./js/restore-from-sheets.js','./js/security-audit-fixes-v65-18-9.js',
