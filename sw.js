const CACHE_NAME = 'maister-treker-v56'; // NEW: 1) у "Звіти" тепер окремо суми готівкою й безготівкою (плюс загальна) та список використаних матеріалів зверху звіту; 2) "Зміни" тепер самі ведуть один живий бекап-повідомлення в Telegram на весь місяць — оновлюється при кожній доданій/видаленій зміні, з 1-го числа автоматично починається нове повідомлення (потрібен заповнений "Ваш особистий Chat ID" у Налаштуваннях).
const CORE_ASSETS = [
  './',
  './index.html',
  './styles.css',
